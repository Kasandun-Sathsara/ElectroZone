        ...
        <div class="row align-items-center">
            ...
            <div class="col-sm-6">
                <div class="header-top-link">
                    <ul class="quick-link">
                        <li><a href="#">Help</a></li>
                        <li><a href="sign-up.jsp">Join Us</a></li>
                ...
                <ul class="action-list">
                    ...
                    <li class="my-account">
                        ...
                        <div class="my-account-dropdown">
                            ...
                            <div class="login-btn">
                                <a href="sign-in.jsp" class="axil-btn btn-bg-primary">Login</a>
                            </div>
                            <div class="reg-footer text-center">No account yet? <a href="sign-up.jsp" class="btn-link">REGISTER HERE.</a></div>
                        </div>
                    </li>
