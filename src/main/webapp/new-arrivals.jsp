...
<head>
    ...
    <title>ElectroZone - New Arrivals</title>
    <!-- Bootstrap 5 CSS -->
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                ...
                <ul class="navbar-nav mb-2 mb-lg-0 fw-medium">
                    <li class="nav-item mx-2">
                        <a class="nav-link text-dark" href="deals.jsp">Deals</a>
                    </li>
                    <li class="nav-item mx-2">
                        <a class="nav-link text-dark" href="new-arrivals.jsp">New Arrivals</a>
                    </li>
                    <li class="nav-item mx-2">
                        <a class="nav-link text-dark" href="brands.jsp">Brands</a>
                    </li>
                </ul>
    ...
    <div class="container mt-4 mb-2">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb fs-7">
                ...
                <li class="breadcrumb-item active text-dark fw-medium" aria-current="page">New Arrivals</li>
            </ol>
        </nav>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <div class="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-3">
                    <h2 class="fw-bold fs-4 mb-0">New Arrivals</h2>
